...
# T159: Add Prometheus metrics middleware
from src.middleware.prometheus_metrics import PrometheusMiddleware, metrics_handler, get_content_type
...
async def metrics():
    """
    T159: Prometheus metrics endpoint.
...
# Include routers
from src.api.routes import auth, tasks, chat, recurring_tasks, audit
